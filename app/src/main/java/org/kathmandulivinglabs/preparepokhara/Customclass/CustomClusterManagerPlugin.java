 ...
 * </p>
 */
public class CustomClusterManagerPlugin<T extends ClusterItem & CustomClusterItem> implements
    ...
    public CustomClusterManagerPlugin(Context context, MapboxMap map) {
        this(context, map, new MarkerManager(map));
    }

    public CustomClusterManagerPlugin(Context context, MapboxMap map, MarkerManager markerManager) {
        mMap = map;
        mMarkerManager = markerManager;
        mClusterMarkers = markerManager.newCollection();
        mMarkers = markerManager.newCollection();
        mRenderer = new KllclusterRenderer<T>(context, map, this);
    ...
    public void setRenderer(ClusterRenderer<T> view) {
        ...
        mRenderer.setOnClusterInfoWindowClickListener((ClusterManagerPlugin.OnClusterInfoWindowClickListener<T>) mOnClusterInfoWindowClickListener);
        mRenderer.setOnClusterItemClickListener((ClusterManagerPlugin.OnClusterItemClickListener<T>) mOnClusterItemClickListener);
        mRenderer.setOnClusterItemInfoWindowClickListener((ClusterManagerPlugin.OnClusterItemInfoWindowClickListener<T>) mOnClusterItemInfoWindowClickListener);
        cluster();
    }
     ...
     * the CustomClusterManagerPlugin must be added as a click listener to the map.
     */
    ...
    /**
     * Sets a callback that's invoked when a Cluster is tapped. Note: For this listener to function,
     * the CustomClusterManagerPlugin must be added as a info window click listener to the map.
     */
    public void setOnClusterInfoWindowClickListener(OnClusterInfoWindowClickListener<T> listener) {
        ...
        mRenderer.setOnClusterInfoWindowClickListener((ClusterManagerPlugin.OnClusterInfoWindowClickListener<T>) listener);
    }

    /**
     * Sets a callback that's invoked when an individual ClusterItem is tapped. Note: For this
     * listener to function, the CustomClusterManagerPlugin must be added as a click listener to the map.
     */
    public void setOnClusterItemClickListener(OnClusterItemClickListener<T> listener) {
        mOnClusterItemClickListener = listener;
        mRenderer.setOnClusterItemClickListener((ClusterManagerPlugin.OnClusterItemClickListener<T>) listener);
    }

    /**
     * Sets a callback that's invoked when an individual ClusterItem's Info Window is tapped. Note: For this
     * listener to function, the CustomClusterManagerPlugin must be added as a info window click listener to the map.
     */
    public void setOnClusterItemInfoWindowClickListener(OnClusterItemInfoWindowClickListener<T> listener) {
        ...
        mRenderer.setOnClusterItemInfoWindowClickListener((ClusterManagerPlugin.OnClusterItemInfoWindowClickListener<T>) listener);
    }

    /**
     * Called when a Cluster is clicked.
     */
    public interface OnClusterClickListener<T extends ClusterItem> extends ClusterManagerPlugin.OnClusterClickListener<T> {
