...
package org.kathmandulivinglabs.exploreindore.Application;
...
//    public ArrayList<Stream> getListStreams(String key){
//        Gson gson = new Gson();
//
//        ArrayList<String> objStrings = getListString(key);
//        ArrayList<Stream> productList =  new ArrayList<Stream>();
//
//        for(String jObjString : objStrings){
//            Stream product  = gson.fromJson(jObjString,  Stream.class);
//            productList.add(product);
//        }
//        return productList;
//    }

//    public void putListStreams(String key, ArrayList<Stream> objArray){
//        checkForNullKey(key);
//        Gson gson = new Gson();
//        ArrayList<String> objStrings = new ArrayList<String>();
//        for(Stream obj : objArray){
